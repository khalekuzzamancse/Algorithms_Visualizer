...
internal class _DFSSequenceBuilder(
    ...
    val iterator: Sequence<SimulationState> = sequence {
        ...
        pushUpdate(SimulationState.Running(initialStartNode, emptyList()))  //push update to UI
        ...
        while (stack.isNotEmpty()) {
            ...
            if (unvisitedNeighbor == null) {
                ...
                //push update to UI
                pushUpdate(SimulationState.Running(updatedTop, pseudocode = emptyList(),peekNode))
