...
val viewModel= remember { BFSRouteController() }
    _BFSSimulation(viewModel=viewModel, navigationIcon = navigationIcon)
}
@OptIn(ExperimentalLayoutApi::class)
@Composable
 fun _BFSSimulation(modifier: Modifier=Modifier, viewModel: RouteController, navigationIcon: @Composable () -> Unit) {
