...
data class DijkstraCodeStateModel(
...
object DijkstraPseudocodeGenerator {
    fun generate(model: DijkstraCodeStateModel) = with(model) { """
 Prims(graph, source) {
   initDistances()
...
""".trimIndent()
    ...
    private fun DijkstraCodeStateModel.showParent()=if(processing!=null&&pendingNeighbours!=null) "//parent:$processing" else ""
