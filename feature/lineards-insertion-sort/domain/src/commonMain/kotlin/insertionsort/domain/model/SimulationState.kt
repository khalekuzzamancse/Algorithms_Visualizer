...
sealed interface SimulationState {
    ...
    data class BackwardPointerChanged(val j: Int, val `j-1`: Int, override val code: String) : SimulationState
    ...
    data class PointerIChanged(val index: Int,val sortedUpTo:Int,override val code: String) : SimulationState
