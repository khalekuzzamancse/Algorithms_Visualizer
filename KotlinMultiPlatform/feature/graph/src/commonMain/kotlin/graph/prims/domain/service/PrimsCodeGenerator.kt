...
data class PrimsCodeStateModel(
...
object PrimsCodeGenerator {
    fun generate(model: PrimsCodeStateModel) = with(model) { """
 Prims(graph, source) {
   initDistances()
...
""".trimIndent()
    ...
    private fun PrimsCodeStateModel.showParent()=if(processing!=null&&pendingNeighbours!=null) "//parent:$processing" else ""
